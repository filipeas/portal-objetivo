...
<body>
    @section('sidebar')
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <a class="navbar-brand" href="{{ route('admin.home') }}">Início</a>

            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.curso.index') }}" title="Cursos do sistema">Cursos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.student.index') }}" title="Alunos do sistema">Alunos</a>
                    </li>
                </ul>

                <div class="text-center">
                    <a class="btn text-gray mr-sm-2" title="Editar perfil" alt="Editar perfil"
                        href="{{ route('admin.config.edit', ['administrador' => Auth::user()->id]) }}">
                        Olá, {{ Auth::user()->name }}
                    </a>
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item"
                                href="{{ route('admin.config.edit', ['administrador' => Auth::user()->id]) }}">Editar
                                perfil</a>
                            <a class="dropdown-item" href="{{ route('admin.config.index') }}">Usuários do sistema</a>
