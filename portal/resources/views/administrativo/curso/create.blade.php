...
@section('content')
    ...
    <div class="bg-gray-apple shadow-sm p-3 mb-5 rounded">
        ...
        <form action="{{ route('admin.curso.store') }}" name="formCreateCurso" method="POST"
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input required name="name" type="text" class="form-control" id="inputCurso"
                            placeholder="Ex: Ciência da Computação" value="{{ old('name') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input required name="start_date" type="date" class="form-control" id="inputCurso"
                            placeholder="Ex: Ciência da Computação" value="{{ old('start_date') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input required name="end_date" type="date" class="form-control" id="inputCurso"
                            placeholder="Ex: Ciência da Computação" value="{{ old('end_date') }}">
